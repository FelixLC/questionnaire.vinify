// describe('Vinibar Purchase Workflow', function () {
//   'use strict';
...
//   it('should choose vinibar', function () {
//     element(by.css('.button.btn-square')).click();
//     // expect(browser.getCurrentUrl()).toEqual('http://0.0.0.0:9001/#/apercu');
//   });

//   it('should fill infos', function () {
//     // fill userinfos
...
//     waitForUrlToChangeTo('http://0.0.0.0:9001/#/remerciement/6');
//   });
