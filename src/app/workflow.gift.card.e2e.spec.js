...
//     element(by.model('gift.order.receiver_address.delivery_address.street')).sendKeys('12 rue boinod');
//     element(by.model('gift.order.receiver_address.delivery_address.zipcode')).sendKeys('75018');
//     element(by.model('gift.order.receiver_address.delivery_address.city')).sendKeys('Paris');
