...
.controller( 'pay_mobileCtrl', ["$scope", "$http", "$location", "currentClient", "$rootScope", "API_ENDPOINT", "$state", function pay_mobileCtrl( $scope, $http, $location, currentClient, $rootScope, API_ENDPOINT, $state ) {
